...
import { getAllDialogsSelector, getError, getIsLoading } from '../../components/redux/dialogs-selectors.ts';
import { fetchDialogs } from '../../components/redux/dialogsPageReducer.ts';
//@ts-ignore
